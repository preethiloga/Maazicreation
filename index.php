...
<body>
  <div class="loader-container">
    <div class="loader">
        <img src="images/favicon.png" alt="Logo" style="z-index: 1; width: 40px;
  height: 40px;"> <!-- Replace with your logo path -->
    </div>
 ...
 ?>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              At Maazicreation, we believe that every space tells a story. Our passion lies in transforming homes, offices, and commercial spaces into personalized environments that inspire, comfort, and elevate the everyday experience.

              Founded on a deep love for design, craftsmanship, and innovation, our team of expert interior designers brings years of experience to every project. From modern minimalism to timeless elegance, we collaborate closely with our clients to create spaces that reflect their unique personality and style.            </p>
            <a href="about.php">
              Read More
            </a>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-md-5 col-lg-6">
          <div class="subscribe-box">
            <h3>
              Subscribe To Our Maazicreation
            </h3>
            <!-- <p>
  ...
  <script>
    // Simulating page load time (optional)
    window.addEventListener('load', function() {
        setTimeout(function() {
            document.querySelector('.loader-container').style.display = 'none';
        }, 2000); // Adjust the timeout for real loading scenarios
    });
</script>
</body>
